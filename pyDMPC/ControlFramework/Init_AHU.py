...
model_path.append('ModelicaModels.SubsystemModels.DetailedModels.AHU.HeatRecovery')
...
model_path.append('ModelicaModels.SubsystemModels.DetailedModels.AHU.PreHeater')
...
num_VarsOut.append(2)
bounds_DVs.append([0,100])
model_path.append('ModelicaModels.SubsystemModels.DetailedModels.AHU.Cooler')
...
num_VarsOut.append(2)
bounds_DVs.append([0,100])
model_path.append('ModelicaModels.SubsystemModels.DetailedModels.AHU.Heater')
...
model_path.append('ModelicaModels.SubsystemModels.DetailedModels.AHU.Humidifier')
