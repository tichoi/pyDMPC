...
public
  Modelica.Fluid.Interfaces.FluidPort_a fieldFluidIn(redeclare package Medium = Water)  annotation (Placement(transformation(extent={{-50,90},{-30,110}})));
  Modelica.Fluid.Interfaces.FluidPort_b fieldFluidOut(redeclare package Medium = Water) annotation (Placement(transformation(extent={{30,90},{50,110}})));
protected
  ...
  //////////////////////////////////////
protected
  AixLib.Utilities.HeatTransfer.Cell3D cell[xSteps,ySteps,n](
  ...
  ///////////////////////////////
  ///// BEGIN: Create CoaxialPipe /////
  ///////////////////////////////
protected
  AixLib.Fluid.HeatExchangers.Geothermal.BoreHoleHeatExchanger.CoaxialPipe CoaxialPipe[noOfPipes](
    redeclare package Medium = Water,
    ...
    m=5) annotation (Placement(transformation(extent={{14,-14},{78,50}})));

  /////////////////////////////
  ///// END: Create CoaxialPipe /////
  /////////////////////////////
...
equation
  ...
  for i in 1:noOfPipes loop
    ...
    connect(CoaxialPipe[i].fluidPortIn, inputMixingVolume.ports[i + 1]);
    connect(CoaxialPipe[i].fluidPortOut, outputMixingVolume.ports[i + 1]);
    for j in 1:n loop
      // Connect pipes to ground
      connect(cell[boreholeGridPositions[i, 1], boreholeGridPositions[i, 2], j].Load1.port,
        CoaxialPipe[i].thermalConnectors2Ground[j]);
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-80,-60},
          ...
          textString="CoaxialPipeField (varPipeType)")}));
